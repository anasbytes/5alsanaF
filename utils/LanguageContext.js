...
const translations = {
    en: {
        ...
        map_view: "Map View",
        explore_facilities: "Explore Facilities",
        locating: "Locating...",
        location_denied: "Location Denied",
        location_unavailable: "Location Unavailable",
        location_error: "Location Error",
        location_not_found_msg: "We couldn't find that location.",
        location_error_msg: "Could not search for location.",
        not_found: "Not Found",
        offline_error: "You appear to be offline. Please check your connection and try again.",
        offline_msg: "You appear to be offline. Please check your connection.",
        recently_viewed: "Recently Viewed",
        slot_taken: "Too late! Someone just booked this exact time slot. Please choose another time.",
        booking_receipt: "Booking Receipt",
        view_receipt: "View Receipt",
        share_booking_invite: "Join me for a game!",
        share: "Share",
        price_breakdown: "Price Breakdown",
        price_per_hour_label: "Price / hr",
        duration: "Duration",
        total: "Total",
        hours: "hrs",
        booking_id: "Booking",
    ...
    ar: {
        ...
        explore_facilities: "استكشف الملاعب",
        locating: "جاري تحديد الموقع...",
        location_denied: "تم رفض الموقع",
        location_unavailable: "الموقع غير متاح",
        location_error: "خطأ في الموقع",
        location_not_found_msg: "لم نتمكن من العثور على هذا الموقع.",
        location_error_msg: "تعذّر البحث عن الموقع.",
        not_found: "غير موجود",
        offline_error: "يبدو أنك غير متصل بالإنترنت. يرجى التحقق من اتصالك والمحاولة مجدداً.",
        offline_msg: "يبدو أنك غير متصل بالإنترنت. يرجى التحقق من اتصالك.",
        recently_viewed: "شوهد مؤخراً",
        slot_taken: "للأسف! تم حجز هذا الوقت للتو. يرجى اختيار وقت آخر.",
        booking_receipt: "إيصال الحجز",
        view_receipt: "عرض الإيصال",
        share_booking_invite: "انضم إليّ في اللعب!",
        share: "مشاركة",
        price_breakdown: "تفاصيل السعر",
        price_per_hour_label: "السعر / ساعة",
        duration: "المدة",
        total: "الإجمالي",
        hours: "ساعة",
        booking_id: "حجز",
        ...
        review_placeholder: "شارك تجربتك (اختياري)",
